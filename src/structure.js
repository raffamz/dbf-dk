 ...
 * @returns {Object} view
 */
module.exports = function structure(data, tamanhoColuna) {
    var tamanhoColuna=tamanhoColuna||16;
    if(typeof tamanhoColuna === "number" ){
        ...
        field_meta.forEach(function (f, i) {
            // field name
            f.name.split('').slice(0, tamanhoColuna).forEach(function (c, x) {
        ...
        console.log("Valor do tamanho da coluna informado na expressão "+"dbf.structure(array,'"+tamanhoColuna+"')"+", deve ser inteiro.");
        return null;
    }
};
